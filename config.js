...
module.exports = {
    ...
    SESSION: process.env.PIKACHU_SESSION === undefined ? 'hehe' : process.env.PIKACHU_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? '~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋' : process.env.ALL_CAPTION,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? 'ɪ ᴀᴍ ᴢᴏʀᴏ 🗡️\n\n   *~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🎸~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋 ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ꜱᴏɴɢ ✮⃝🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋 ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ꜱᴏɴɢ ✮⃝🎧' : process.env.SONGU,
    ...
    YAK: process.env.YAK === undefined ? '917356561110,0' : process.env.YAK,
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? '~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋' : process.env.OWNER_SHIP,
    LOGO: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/8wloDRs.jpeg' : process.env.LOGO_LINK,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ɪ ᴀᴍ ᴢᴏʀᴏ 🗡️' : process.env.BOTV2_NAME,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '~ī.am🍷҉  𝛥𝛮𝛥𝛮𝐷𝛨𝑈 𝛧𝛯𝑅🧋' : process.env.LOGO_NAME,
